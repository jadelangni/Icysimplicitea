        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6">
                    <form method="GET" action="{{ route('reports.monthly') }}" class="flex items-end gap-4">
                        <div>
                            ...
                            <select name="month" id="month" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-simplicitea-500 focus:ring-simplicitea-500">
                                @for($i = 1; $i <= 12; $i++)
                        ...
                        <div>
                            ...
                            <select name="year" id="year" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-simplicitea-500 focus:ring-simplicitea-500">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        @else
                            <p class="text-gray-500 text-center py-8">No product data available for selected month.</p>
                        @endif
                    </div>
                </div>
            </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 {{ $day['revenue'] == 0 ? 'opacity-50' : '' }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($totalRevenue > 0)
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <span class="ml-2 text-sm text-gray-500">{{ number_format($percentage, 1) }}%</span>
                                            </div>
                                        @else
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-8">
                <div class="p-6 text-center">
                    ...
                    <p class="text-gray-500 text-lg mb-2">No data found</p>

...
<!-- Sidebar -->
<div class="app-sidebar" :class="{ 'open': sidebarOpen }" @click.away="if (window.innerWidth < 1024) sidebarOpen = false">
    <!-- User Profile -->
    <div class="p-4 border-b border-gray-700">
        <div class="flex items-center gap-3">
            ...
            <!-- Dark Mode Toggle -->
            <button type="button" @click="toggleDarkMode()" class="p-2 rounded-lg bg-gray-800 hover:bg-gray-700 transition-colors" title="Toggle Dark Mode">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full p-6" @click.stop>
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('logout.prepare') }}" 
                   class="flex-1 px-4 py-2.5 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 transition-colors text-center">
                    Yes, Log Out
                </a>
            </div>
        </div>
